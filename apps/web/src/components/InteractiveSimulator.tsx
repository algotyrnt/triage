...
export const InteractiveSimulator: React.FC = () => {
  ...
  return (
    <section id="simulator" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto scroll-mt-20">
      {/* Header section */}
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-2.5">
        {SCENARIOS.map((s) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md font-mono text-xs transition-all border ${
              selectedId === s.id
