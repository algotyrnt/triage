...
const getPackageFromPath = (path: string): string => {
    ...
    return files.map((file) => {
        ...
        return (
          <div key={file.path} className="font-mono text-xs">
            <div
              ...
              className="flex items-center gap-1.5 py-1 px-2 hover:bg-slate-100 rounded-sm cursor-pointer text-slate-700 select-none focus:outline-none focus:ring-1 focus:ring-black"
      ...
      return (
        <div
          ...
          className={`flex items-center justify-between py-1 px-2 text-xs font-mono rounded-sm cursor-pointer select-none focus:outline-none focus:ring-1 focus:ring-black ${
            isSelected
